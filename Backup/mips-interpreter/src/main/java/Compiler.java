...
public class Compiler {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("------Printing Outputted File-----");
        System.out.println(LiveRange.functionMipsCode);
        System.out.println("-----Complete Printing-----");

        PrintWriter writer = new PrintWriter(new File("out.s"));
        for (String func : LiveRange.functionMipsCode.keySet()) {
            writer.println(func + ':');
            writer.print(LiveRange.functionMipsCode.get(func));
            writer.flush();
        }
        writer.close();
